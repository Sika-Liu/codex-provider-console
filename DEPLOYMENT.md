...
## Apply configuration after switching providers

After a provider switch succeeds, the top-right **应用配置** button becomes
available. It resets the Codex login session managed by the panel so
